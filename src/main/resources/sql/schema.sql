...
CREATE TABLE IF NOT EXISTS T_FORM_VARIANT (
	F_VARIANT_ID INTEGER NOT NULL,
	F_OWNER_FORM_ID INTEGER NOT NULL,
	F_WIDTH INTEGER NOT NULL,
...
CREATE TABLE IF NOT EXISTS T_LAYOUT (
	...
	F_OWNER_VARIANT_ID INTEGER NOT NULL,
	F_NAME TEXT NOT NULL,
	F_PARENT_LAYOUT_ID INTEGER NOT NULL,
	F_TARGET_TYPE INTEGER NOT NULL,
	F_TARGET_FIELD_FIELD_ID INTEGER NOT NULL,
	F_TARGET_MESSAGE_MESSAGE_ID INTEGER NOT NULL,
	F_STYLE_STYLE_ID INTEGER NOT NULL,
	F_LEFT TEXT ,
	F_TOP TEXT ,
	F_RIGHT TEXT ,
	F_BOTTOM TEXT ,
	...
	FOREIGN KEY (
		F_TARGET_FIELD_FIELD_ID
	) REFERENCES T_FIELD (
		F_FIELD_ID
	)
	FOREIGN KEY (
		F_TARGET_MESSAGE_MESSAGE_ID
	) REFERENCES T_MESSAGE (
		F_MESSAGE_ID
	)
	FOREIGN KEY (
