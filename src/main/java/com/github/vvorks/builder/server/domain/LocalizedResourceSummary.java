 ...
 * ローカライズドリソースのサマリー情報
 */
public class LocalizedResourceSummary<T> {
	...
	public boolean equals(Object obj) {
		if (this == obj) {
			...
			LocalizedResourceSummary<T> other = (LocalizedResourceSummary<T>) obj;
			return equals(other);
		}
	}

	private boolean equals(LocalizedResourceSummary<T> other) {
		return
