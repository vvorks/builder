 ...
 * スタイル条件のサマリー情報
 */
public class StyleConditionSummary<T> {
	...
	public boolean equals(Object obj) {
		if (this == obj) {
			...
			StyleConditionSummary<T> other = (StyleConditionSummary<T>) obj;
			return equals(other);
		}
	}

	private boolean equals(StyleConditionSummary<T> other) {
		return
	...
	public String toString() {
		...
		sb.append("StyleConditionContent [");
