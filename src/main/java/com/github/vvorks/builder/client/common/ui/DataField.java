...
public interface DataField {
	 ...
	 * 		文字入力を行うキーの場合、真
	 */
	public default boolean isCharKey(int keyCode, int mods) {
	 ...
	 * 		IME入力キーの場合、真
	 */
	public default boolean isImeKey(int keyCode, int mods) {
	 ...
	 * 		全編集開始キーの場合、真
	 */
	public default boolean isEditKey(int keyCode, int mods) {
	 ...
	 * 		カーソル移動キーの場合、真
	 */
	public default boolean isArrowKey(int keyCode, int mods) {
	 ...
	 * 		決定キーの場合、真
	 */
	public default boolean isEnterKey(int keyCode, int mods) {
		if ((mods & KeyCodes.MOD_ACS) != 0) {
			return false;
		}
	 ...
	 * 		戻るキーの場合、真
	 */
	public default boolean isEscKey(int keyCode, int mods) {
		if ((mods & KeyCodes.MOD_ACS) != 0) {
			return false;
		}
